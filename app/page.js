      ...
      <div className="max-w-4xl w-full bg-white shadow-lg rounded-lg p-8 md:p-12 lg:p-16">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 text-justify">
            ...
            thrive in team environments. I prioritize code quality and
            maintainability, ensuring clean, modular, and well-documented code.
            Exploring my GitHub repositories, you'll find projects reflecting my
            expertise and dedication to continuous learning. I'm always open to
